...
async def get_team_statics_data(league:str, team:str, season:str, date:str):
    ...
    return make_json(base_url, "/api/app/datas/json/season_23/teams_statistics")
...
async def get_team_data(league:str, season:str):
    ...
    return make_json(base_url, "/api/app/datas/json/season_23/teams")
...
async def get_standing_data(league:str, season:str):
    ...
    return make_json(base_url, "/api/app/datas/json/season_23/standings")
...
async def get_predictions_data(fixture: str):
    ...
    return make_json(base_url, "/api/app/datas/json/season_23/predictions")
...
async def get_topscorers_data(league:str, season:str):
    ...
    return make_json(base_url, "/api/app/datas/json/season_23/players-topscorers")    
...
async def get_squads_data(team:str):
    ...
    return make_json(base_url, "/api/app/datas/json/season_23/players-squads")
...
async def get_players_data(league:str, team:str, season:str, page:str):
    ...
    return make_json(base_url, "/api/app/datas/json/season_23/players")
...
async def get_fixtures_data(league:str, season:str, date:str, timezone:str):
    ...
    return make_json(base_url, "/api/app/datas/json/season_23/fixtures")
...
async def get_events_data(fixture:str):
    ...
    return make_json(base_url, "/api/app/datas/json/season_23/fixtures_events")
...
async def get_headtohead_data(h2h: str, date:str, timezone:str):
    ...
    return make_json(base_url, "/api/app/datas/json/season_23/fixtures_headtohead")
...
async def get_lineups_data(fixture: str):
    ...
    return make_json(base_url, "/api/app/datas/json/season_23/fixtures_lineups")
...
async def get_fplayers_data(fixture: str):
    ...
    return make_json(base_url, "/api/app/datas/json/season_23/fixtures_players")
...
async def get_fsattistics_data(fixture:str):
    ...
    return make_json(base_url,  "/api/app/datas/json/season_23/fixtures_statistics")
